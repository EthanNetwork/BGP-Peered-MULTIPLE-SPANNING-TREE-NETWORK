...
Platform: EVEN-NG, IOSv images  Scope: Dual-homed BGP edge design, OSPF/HSRP distribution, and a multi-region MST access layer with EtherChannel — built to demonstrate CCNP-level routing and switching skills in one topology.
